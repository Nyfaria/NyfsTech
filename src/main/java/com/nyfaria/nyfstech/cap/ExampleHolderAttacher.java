package com.nyfaria.nyfstech.cap;
...
@Mod.EventBusSubscriber(modid = NyfsTech.MODID)
public class ExampleHolderAttacher extends CapabilityAttacher {
    ...
    public static final ResourceLocation EXAMPLE_RL = new ResourceLocation(NyfsTech.MODID, "example");
